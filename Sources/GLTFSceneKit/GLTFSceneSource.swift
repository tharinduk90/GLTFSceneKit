...
public class GLTFSceneSource : SCNSceneSource {
    ...
    public convenience init(path: URL, options: [SCNSceneSource.LoadingOption : Any]? = nil, extensions: [String:Codable.Type]? = nil) throws {
        self.init()
    ...
    public convenience init(named name: URL, options: [SCNSceneSource.LoadingOption : Any]? = nil, extensions: [String:Codable.Type]? = nil) throws {
...
//        }
        try self.init(path: name, options: options, extensions: extensions)
    }
